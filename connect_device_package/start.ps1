...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a2x5w8hvbskv9v-ats.iot.ap-southeast-2.amazonaws.com --ca_file root-CA.crt --cert demoThing.cert.pem --key demoThing.private.key --client_id basicPubSub --topic sdk/test/python --count 0